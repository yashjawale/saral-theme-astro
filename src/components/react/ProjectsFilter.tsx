...
export default function ProjectsFilter() {
    ...
    const NoProjectsGR = "Δεν βρέθηκαν projects σε αυτή την κατηγορία.";
    const NoProjectsEN = "No projects found for the selected filter.";
    ...
    return (
        <div className="flex flex-col gap-12">
            <div className="flex flex-wrap gap-2">
                ...
                {ProjTypes.map((type) => (
                    <FilterBtn type={type} handle={() => { setFilter(type) }} active={selectedType === type} />
                ))}
